...
<?php include 'template/header.php'; ?>
  <body>
    ...
    <section class="home-slider owl-carousel">
      ...
      <div class="slider-item" style="background-image: url('images/bg_3.jpeg');">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center text-center">
            <div class="col-md-10 col-sm-12 ftco-animate">
          ...
          <div class="col-lg-6">
            <div class="block-3 d-md-flex ftco-animate">
              ...
              <div class="text text-center order-first">
                ...
                <p>A beefsteak, often called just steak, is a flat cut of beef with parallel faces, usually cut perpendicular to the muscle fibers.</p>
            ...
            <div class="block-3 d-md-flex ftco-animate">
              ...
              <div class="text text-center order-first">
                ...
                <p>Skirt steak is a cut of beef steak from the plate. It is long, flat, and prized for its flavor rather than tenderness. It is not to be confused with flank</p>
          ...
          <div class="col-lg-6">
            <div class="block-3 d-md-flex ftco-animate">
              ...
              <div class="text text-center order-first">
                ...
                <p>Chop suey is a dish in American Chinese cuisine.American chop suey, a name for an American dish consisting of ground beef, elbow macaroni and a tomato based sauce</p>
            ...
            <div class="block-3 d-md-flex ftco-animate">
              ...
              <div class="text text-center order-first">
                <h2 class="heading">Roasted Chicken</h2>
                <p>over a fire, or with a rotisserie (rotary spit). Generally, the chicken is roasted with its own fat and juices by circulating the meat during roasting</p>
                <span class="price">from ₹90.00</span>
              </div>
            </div>
          </div>
